...
🟩 1. Dépôts officiels Termux (MAIN – indispensables)
...
🟦 2. Dépôts militaires “MAIN” fiables (non-officiels mais stables)
...
🛡️ BlackArch (via AnLinux) — dépôt militaire OSINT/RedTeam
...
🟩 3. Dépôts GitHub “MAIN” pour OSINT / BlueTeam / RedTeam
Ce sont des dépôts de référence, utilisés dans les unités cyber.

---

🛰️ SecLists (MAIN OSINT / Pentest)
...
🛰️ PayloadsAllTheThings (MAIN RedTeam)
...
🛰️ French OSINT Pack (MAIN France)
...
🛰️ BlueTeam Toolkit (MAIN défense)
...
🛰️ RedTeam Arsenal (MAIN attaque)
...
🟦 4. Dépôts Python “MAIN” OSINT / Cyber
...
🔥 un script install-military-repos.sh
qui installe :

- tous les dépôts  
- organise ton arborescence militaire  
- configure ton environnement LÉGION  
- sans nano  
- 100 % automatique
